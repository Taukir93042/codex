...
const Testimonial = () => {
  ...
  return (
    <section className="py-16 bg-[#03050c]/40 px-10 border-y border-slate-800/40">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center">
          <span className="px-6 py-2 rounded-full bg-indigo-500/10 text-indigo-400 border border-indigo-500/20 font-semibold uppercase tracking-wider text-sm">
            Testimonials
          </span>
